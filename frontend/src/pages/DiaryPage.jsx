import { generateDiaryPDF } from '../utils/generateDiaryPDF.js'
    ...
    <div className="flex flex-col animate-fade-up px-4 md:px-8 py-6 max-w-4xl mx-auto w-full pb-32">
      ...
      {total > 0 && (
        <button
          ...
          className="flex items-center justify-center gap-2 w-full md:w-auto md:ml-auto mb-6 px-6 py-3 rounded-xl bg-surface-100 border border-white/10 hover:border-white/20 hover:bg-surface-200 text-white/70 hover:text-white transition-all text-sm font-bold shadow-sm disabled:opacity-50"
        >
          {downloading
